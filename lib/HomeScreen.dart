      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 385.0, 612.0),
                    size: Size(385.0, 612.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(22.0, 0.0, 342.0, 612.0),
                          size: Size(385.0, 612.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(338.0, 324.0, 47.0, 49.0),
                          size: Size(385.0, 612.0),
                          pinRight: true,
                          fixedWidth: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 324.0, 47.0, 49.0),
                          size: Size(385.0, 612.0),
                          pinLeft: true,
                          fixedWidth: true,
                          fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(108.0, 27.0, 170.0, 24.0),
                    size: Size(385.0, 612.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(122.0, 126.0, 142.0, 74.0),
                    size: Size(385.0, 612.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'langfr-280px-Maroc_…' (shape)
                        Container(
                      decoration: BoxDecoration(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(93.0, 292.0, 201.0, 78.0),
                    size: Size(385.0, 612.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Inwi-Logo' (shape)
                        Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: const AssetImage(''),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(121.0, 462.0, 145.0, 108.0),
                    size: Size(385.0, 612.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'account-cog' (shape)
                PageLink(
              links: [
                PageLinkInfo(
